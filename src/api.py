"""FastAPI application for vision-language-search."""
...
app = FastAPI(title="vision-language-search", version="0.1.0", description="vision-language-search API")
...
@app.get("/health")
def health():
    return {"status": "ok", "service": "vision-language-search", "version": "0.1.0"}
...
async def process(req: ProcessRequest):
    ...
    try:
        ...
        resp = ProcessResponse(success=True, result=result, processing_time_ms=round(elapsed, 2),
                              metadata={"service": "vision-language-search", "input_length": len(req.input)})
...
@app.get("/status")
def status():
    return {"service": "vision-language-search", "version": "0.1.0", "ready": True,
